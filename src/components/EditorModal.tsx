            ...
            try {
                if (snippet.code_content && snippet.code_content.trim().startsWith('{"__multi":true')) {
                    ...
                    if (parsed.files && parsed.files.length > 0) {
                        setCodeContent(parsed.files[0].content || '');
                        setLanguage(parsed.files[0].language || 'JavaScript');
                    } else {
                        setCodeContent('');
    ...
    return (
        <div className="modal-overlay active" onClick={onClose}>
            <div className="modal-content" onClick={e => e.stopPropagation()} style={{ height: '85vh' }}>
                ...
                <div className="modal-editor" style={{ display: 'flex', flexDirection: 'column', padding: 0, flex: 1, minHeight: 0, overflow: 'hidden' }}>
                ...
                <div className="modal-footer" style={{ flexShrink: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', borderTop: '1px solid var(--border-color)', background: 'var(--card-bg)' }}>
            ...
            {showHistory && snippet && (
                <HistoryModal 
                    ...
                    currentCodeContent={codeContent}
                    locale={locale}
